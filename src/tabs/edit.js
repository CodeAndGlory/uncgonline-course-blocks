...
const ALLOWED_BLOCKS = ['uncgonline-block/tab-pane'];
...
export default function Edit(props) {
	...
	const handleAddTab = () => {
		...
		const tabId =
			'uncgonline-block-' + props.clientId + '-child-pane-' + tabNumber;
		...
		const parentBlock = document.getElementById(
			'uncgonline-block-' + props.clientId + '-tab-content'
		);
	...
	return (
		<div {...useBlockProps()}>
			<ul
				...
				role={'tablist'}
				id={'uncgonline-block-' + props.clientId + '-tabs'}
			>
				{tabTitlesDisplay}
				<Button
			...
			<div
				...
				id={'uncgonline-block-' + props.clientId + '-tab-content'}
			>
